...
下文前几节先把 **c456.com 账号**、本机 `**c456` 命令**、以及 **Agent 技能**装好，让 **Cursor / OpenCode / Trae / Claude Code** 里的 AI 能按规范代你操作 C456 与本地 Wiki；第 4 节是**第一次**在本文件夹当知识库时的初始化口令。
...
| 技能 | 作用 | 来源 |
|------|------|------|
| **llm-wiki-domains** | 多领域知识库导航，每个领域独立 llm-wiki 实例 | [c456-com/skills](https://github.com/c456-com/skills) |
| **c456-llm-wiki** | 与 C456 双向同步、`c456-sync/` 等 | [c456-com/skills](https://github.com/c456-com/skills/tree/main/c456-llm-wiki) |
| **c456-cli** | 终端 `c456` 与 HTTP API 的 Agent 说明 | [c456-com/skills](https://github.com/c456-com/skills/tree/main/c456-cli) |
...
3. 在对话里直接说你要做什么（见下一节**可复制示例**）。Agent 会按 **llm-wiki-domains**（多领域导航）、**c456-llm-wiki**（C456 同步）与 **c456-cli**（终端命令）三个技能，在本机执行 `c456`、维护 `wiki/` 与 `c456-sync/` 等；你主要负责说清楚意图与确认结果。
...
- [llm-wiki-domains 技能（多领域知识库导航）](https://github.com/c456-com/skills/tree/main/llm-wiki-domains)
- [c456-llm-wiki 技能（与 C456 双向同步）](https://github.com/c456-com/skills/tree/main/c456-llm-wiki)
- [c456-cli 技能](https://github.com/c456-com/skills/tree/main/c456-cli)
